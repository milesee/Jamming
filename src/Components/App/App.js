      ...
      <div>
        ...
        <div className="App">
          ...
          <div className="App-playlist">
            ...
            <Playlist playlist={this.state.playlistTracks} playlistName={this.state.playlistName} onRemove={this.removeTrack} onNameChange={this.updatePlaylistName} onSave={this.savePlaylist}/>
          </div>
        </div>
      </div>
    );
